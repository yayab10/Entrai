...
let guerrier = new joueur (10, 3, 3, function(){ return "Découpage de tête"})
...
// Création personages de gauche
    ...
    // persoGuerrier1.style.marginBottom = "1em"
    ...
    persoMage1.style.marginBottom = "1em"
    ...
    persoPretre1.style.marginBottom = "1em"
    ...
    persoGuerrier2.style.marginBottom = "1em"
    ...
    persoMage2.style.marginBottom = "1em"
    ...
    persoPretre2.style.marginBottom = "1em"
    ...
    // Création de l'évènement sur le personnage Guerrier 1
        ...
        pointVie = guerrier.pointsVie
        pointAttaque = guerrier.pointsAttaque
        pointDefense = guerrier.pointsAttaque
        laSpecial = guerrier.capaciteSpecial
    })
      // Création de l'évènement sur le personnage Mage 1
        ...
        compteur++
        console.log(compteur);
        pointVie = mage.pointsVie
        pointAttaque = mage.pointsAttaque
        pointDefense = mage.pointsAttaque
        laSpecial = mage.capaciteSpecial
    })
    ...
    persoPretre1.addEventListener("click", () => {
        ...
        compteur++
        console.log(compteur);
        pointVie = pretre.pointsVie
        pointAttaque = pretre.pointsAttaque
        pointDefense = pretre.pointsAttaque
        laSpecial = pretre.capaciteSpecial
    })
    ...
    pointAttaque2 = guerrier2.pointsAttaque
    pointDefense2 = guerrier2.pointsAttaque
    laSpecial2 = guerrier2.capaciteSpecial
    console.log(pointVie);
      ...
      // Création de l'évènement sur le personnage Mage 2
        ...
        console.log(compteur);
        document.body.appendChild(buttonDemarrage)
        pointVie2 = mage2.pointsVie
        pointAttaque2 = mage2.pointsAttaque
        pointDefense2 = mage2.pointsAttaque
        laSpecial2 = mage2.capaciteSpecial
    })   
       ...
       // Création de l'évènement sur le personnage Prêtre 2
        ...
        console.log(compteur);
        document.body.appendChild(buttonDemarrage)
        pointVie2 = pretre2.pointsVie
        pointAttaque2 = pretre2.pointsAttaque
        pointDefense2 = pretre2.pointsAttaque
        laSpecial2 = pretre2.capaciteSpecial
    })   
    ...
    buttonDemarrage.addEventListener("click", function(){
        ...
        if(compteur === 2){
            ...
            buttonVie.textContent = "Vie: " + pointVie
            buttonAttaque.textContent = "Attaque: " + pointAttaque
            // buttonDefense.textContent = "Défense: " + pointDefense
            buttonSpeciale.textContent = "Capacité Spéciale: " 
            ...
            buttonVie2.textContent = "Vie: " + pointVie2
            buttonAttaque2.textContent = "Attaque: " + pointAttaque2
            // buttonDefense2.textContent = "Défense: " + pointDefense2
    ...
    buttonVie.textContent = "Vie: " + parseInt( pointVie += Math.floor(Math.random() * pointDefense))
    desactiveButton(buttonAttaque, buttonVie, buttonSpeciale)
    activeButton(buttonAttaque2, buttonVie2, buttonSpeciale2)
    })

    buttonVie2.addEventListener("click", () => {
    buttonVie2.textContent = "Vie: " + parseInt( pointVie2 += Math.floor(Math.random() * pointDefense2))
    desactiveButton(buttonAttaque2, buttonVie2, buttonSpeciale2)
    activeButton(buttonAttaque, buttonVie, buttonSpeciale)
    })
        
     // DESACTIVATION BUTTON APRES JEU
    function desactiveButton(a, b, c){
        a.disabled = true 
        b.disabled = true
        c.disabled = true
    }
    function activeButton(a, b, c){
        a.disabled = false
        b.disabled = false
        c.disabled = false
    }
    ...
    buttonVie2.textContent = "Vie: " + parseInt(pointVie2 -= 1)
    gameOver(pointVie2)
    ...
    buttonAttaque2.addEventListener("click", () => {
    buttonVie.textContent = "Vie: " + parseInt(pointVie -= 1)
    console.log(pointVie);
    gameOver(pointVie)
    desactiveButton(buttonAttaque2, buttonVie2, buttonSpeciale2)
    activeButton(buttonAttaque, buttonVie, buttonSpeciale)
    ...
    // ATTAQUE SPE
    buttonSpeciale.addEventListener("click", () => {
    buttonVie2.textContent = "Vie: " + parseInt( pointVie2 -= Math.floor(Math.random() * pointDefense2) + 1)
    console.log(pointVie2);
    gameOver(pointVie2)
    desactiveButton(buttonAttaque, buttonVie, buttonSpeciale)
    activeButton(buttonAttaque2, buttonVie2, buttonSpeciale2)
    ...
    buttonSpeciale2.addEventListener("click", () => {
    buttonVie.textContent = "Vie: " + parseInt(pointVie -= Math.floor(Math.random() * pointDefense) + 1)
    console.log(pointVie);
    gameOver(pointVie)
    desactiveButton(buttonAttaque2, buttonVie2, buttonSpeciale2)
    activeButton(buttonAttaque, buttonVie, buttonSpeciale)
    ...
    if(data <= 0 ){
        ...
        desactiveButton(buttonAttaque2, buttonVie2, buttonSpeciale2)
        alert("END")
        const redemarrer = document.createElement("button")
        redemarrer.textContent = "REDEMARRER"
        document.body.appendChild(redemarrer)
